...
This research must genuinely inform Sections 2–8. Do not treat it as a checkbox — the final rationale for each major visual decision (palette, nav bar behavior, motion choices, card treatments) should be able to reference a concrete design principle or precedent, not just aesthetic preference.
